...
--language=ru --seed=1 --lr=2e-5 --epoch=22 --use-crf=True --augment-type=all  --augment-rate=0.05 --batch-size=64 \
--alpha-sub=0.4 --alpha-del=0.4 --data-path=data/ru/*.txt --save-path=out --sequence-length 128 --yttm yttm.model #--hg True
